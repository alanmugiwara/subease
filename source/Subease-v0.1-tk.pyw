...
window = tk.Tk()
window.title("SubEase v0.1 - Otimizador de busca por legendas by @alanmugiwara")
window.geometry("560x450")


# Rótulo e campo de entrada
Label(window, text="Digite ou cole o título do seu arquivo:").grid(row=0, column=0, padx=10, pady=(10, 0), sticky='w')
